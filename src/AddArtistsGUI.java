    ...
    private void createGUI(Main main, String name, Agenda agenda) {
        ...
        addButton.addActionListener(e -> {
            if(!nameText.getText().equals("") && !genreText.getText().equals("")) {
                ...
                JOptionPane.showMessageDialog(this, "Artist added", "Add Artists", JOptionPane.INFORMATION_MESSAGE);
                nameText.setText("");
                genreText.setText("");
            } else {
                JOptionPane.showMessageDialog(this, "Please enter all fields.", "Add Artists", JOptionPane.WARNING_MESSAGE);
            }
        });
