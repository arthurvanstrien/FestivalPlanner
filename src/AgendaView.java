...
public class AgendaView extends JTable {
    ...
    private class ShowEditWindow extends JDialog {
        ...
        public ShowEditWindow(int row, int col) {
            ...
            JScrollPane centerPanel = new JScrollPane(artistsPanel, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        ...
        private void showWarning(Exception e) {
            JOptionPane.showMessageDialog(this, e.getMessage(), "Show", JOptionPane.WARNING_MESSAGE);
        }
    }
    ...
    private class ShowDisplayWindow extends JDialog {
        public ShowDisplayWindow(int row, int col) {
            ...
            if (show != null) {
                ...
                JScrollPane artistPane = new JScrollPane(nameText, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
                ...
                JLabel expectedPopularityTextLabel = new JLabel(String.valueOf(show.getExpectedPopularity()));
                ...
                JOptionPane.showMessageDialog(AgendaView.this, "No show.", "Show", JOptionPane.WARNING_MESSAGE);
            }
        }
    }
}