...
public class TestPeriod {
    public static int runTest() {
        ...
        if(!period.getBeginTime().equals(beginTime)) {
            System.out.println("There is a problem with the getBeginTime method of the Period class.");
            errors++;
        }

        if(!period.getEndTime().equals(endTime)) {
            System.out.println("There is a problem with the getEndTime method of the Period class.");
            errors++;
        }

        period.setBeginTime(secondBeginTime);
        if(!period.getBeginTime().equals(secondBeginTime)) {
            System.out.println("There is a problem with the getBeginTime or setBeginTime method of the Period class.");
            errors++;
        }

        period.setEndTime(secondEndTime);
        if(!period.getEndTime().equals(secondEndTime)) {
            System.out.println("There is a problem with the getEndTime of setEndTime method of the Period class.");
            errors++;
        }
