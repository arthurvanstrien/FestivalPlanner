...
public class TestAgenda {
    public static int runTest() {
        ...
        if(agenda.getArtists().size() != 10) {
            System.out.println("There is a problem with the getArtists method of the Agenda class.");
            errors++;
        }
        ...
        if(agenda.getArtists().size() != 11) {
            System.out.println("There is a problem with the addArtists method of the Agenda class.");
            errors++;
        }
        ...
        if(agenda.getStages().size() != 3) {
            System.out.println("There is a problem with the getStages method of the Agenda class.");
            errors++;
        }
