...
public class TestTime {
    public static int runTest() {
        ...
        time.setHour(10);
        if(time.getHour() != 10){
            System.out.println("There is a problem with the getHour or setHour method of the Time class.");
            errors++;
        }

        time.setMinute(4);
        if(time.getMinute() != 4){
            System.out.println("There is a problem with the getMinute or setMinute method of the Time class.");
            errors++;
        }
