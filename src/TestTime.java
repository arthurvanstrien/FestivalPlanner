...
public class TestTime {
  ...
  public static int runTest() {
    ...
    if (time.getHour() != 10) {
      System.out
          .println("There is a problem with the getHour or setHour method of the Time class.");
      errors++;
    }
    ...
    if (time.getMinute() != 4) {
      System.out
          .println("There is a problem with the getMinute or setMinute method of the Time class.");
      errors++;
    }
