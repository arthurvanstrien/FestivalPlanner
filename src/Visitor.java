...
public class Visitor implements Drawable {
     ...
     * @param drawings contains a list of all other objects that have been drawn.
     * The Method wil cycle through te list to meet all constraints and collisions with the objects.
     */
    @Override
